...
public class ChildAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = mInflater.inflate(R.layout.picture_child_item, null);
			viewHolder = new ViewHolder();
			viewHolder.mImageView = (MyImageView) convertView.findViewById(R.id.picture_child_image);
			viewHolder.mCheckBox = (CheckBox) convertView.findViewById(R.id.picture_child_checkbox);
